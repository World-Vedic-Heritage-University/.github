...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#text02', { style: 'fade-left', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text01', { style: 'fade-in', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text06', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text03', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text49', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text09', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text04', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text05', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text07', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text08', { style: 'fade-down', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
